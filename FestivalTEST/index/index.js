        ...
        <div class="event-card column" onclick="openSelectedFestival(${festival.esId})">
            <div class="column card-info">
                <div class="card-image">
                    <img src="${renderCardImages(festival.esPictureBig)}">
                </div>
                <div class="column gap-10">
                    ...
                    <div class="row">
                        ...
                        <span class="event-date">${singleEvent.eventDateIso8601}</span>
                    </div>
                </div>
            </div>
        </div>
...
// function renderEvents({esId, esName, esPictureBig}, {eventCountry, eventCity, eventDateIso8601}) {
//     return /*html*/ `
//         <div class="event-card column" onclick="openSelectedFestival(${esId})">
//             <div class="column card-info">
//                 <div class="card-image">
//                     <img src="${renderCardImages(esPictureBig)}">
//                 </div>
//                 <div class="column gap-10">
//                     <span class="event-name">${highlightIfContains(esName, currentInput)}</span>
//                     <div class="row event-country-container">
//                         <span class="event-country">${highlightIfContains(eventCountry, currentInput)}</span>
//                     </div>
//                     <div class="row">
//                         <span class="event-location">${highlightIfContains(eventCity, currentInput)}</span>
//                         <span class="event-date">${eventDateIso8601}</span>
//                     </div>
//                 </div>
//             </div>
//         </div>
...
async function renderCardImages() {
    const events = await getFestivals().esBigPicture;
    // log(events)
